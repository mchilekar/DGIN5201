...
<form action = "" method = "POST">
    <div class ="form-container-2">
        ...
        <a style="text-align: center; font-size: 20px;" href = "templates/logout.php">Logout</a>
    </div>
</form>
